...
pub enum Relation {
    ...
    FantasyPick,
    #[sea_orm(has_many = "super::fantasy_tournament_division::Entity")]
    FantasyTournamentDivision,
    #[sea_orm(
...
impl Related<super::fantasy_tournament_division::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::FantasyTournamentDivision.def()
    }
}
